...
public class Lead implements Serializable {
    ...
    @ManyToMany
    @JoinTable(name = "rel_lead__tags", joinColumns = @JoinColumn(name = "lead_id"), inverseJoinColumns = @JoinColumn(name = "tags_id"))
    @JsonIgnoreProperties(value = { "leads" }, allowSetters = true)
    private Set<Tag> tags = new HashSet<>();

    @ManyToMany
    @JoinTable(name = "rel_lead__lista", joinColumns = @JoinColumn(name = "lead_id"), inverseJoinColumns = @JoinColumn(name = "lista_id"))
    @JsonIgnoreProperties(value = { "leads" }, allowSetters = true)
